...
LABEL org.opencontainers.image.title="Course Management Toolkit" \
	org.opencontainers.image.source="https://github.com/hoanganhduc/course" \
	org.opencontainers.image.description="Course management utilities for roster, grading, OCR, and LMS workflows" \
...
# Clone and install course management toolkit
WORKDIR /app
RUN git clone https://github.com/hoanganhduc/course_management_toolkit.git . && \
