...
- The CLI was pinned at `gh teacher` v1.25.1, commit
  `b9fbf2a8526ca7b20cc50c27d5419f6e07eaeea6`, when this surface was written. Subcommand
  syntax, flags, and idempotency behaviour are taken from that build's own help output and
  the pinned `schemas/assignments-v1.schema.json`. The installed extension was upgraded to
  v1.45.0 on 2026-09-05; the argv and flag names this surface emits are unchanged there, but
  the assignment slug cap was raised upstream — see "Divergence after the v1.45.0 upgrade"
  in the roster-onboarding TASKS.md.
